  ...
  return (
    <div className="pb-16 font-thin bg-orange-50 px-4 md:px-16">
      ...
      <div className="flex justify-center items-center w-full">
        <div className="flex flex-col md:flex-row justify-center items-center space-y-10 md:space-y-0 md:space-x-10 pt-12">
          <div className="border border-slate-400 px-6 py-8 md:px-10 md:py-10 text-center rounded-3xl shadow-lg bg-white w-full max-w-xs md:max-w-none">
